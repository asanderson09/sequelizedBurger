$(document).ready(function() {
  ...
  // Our devoured burgers will go inside the devouredContainer
  ...
  function createNewRow(burger) {
    var $newInputRow = $(
      [
        ...
        "<button class='devoured btn btn-primary'>Devour IT!</button>",
        "</li>"
      ].join("")
    );
    ...
    if (burger.devoured) {
      $newInputRow.find("span").css("burger_name-decoration", "line-through");
    }
    return $newInputRow;
  }
